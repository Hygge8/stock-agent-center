...
class Settings:
    ...
    uzi_api_url: str = os.getenv("UZI_API_URL", "http://host.docker.internal:8977").rstrip("/")
    ...
    schedule_tickers: list[str] = None  # type: ignore[assignment]
    ...
    def __post_init__(self) -> None:
        object.__setattr__(self, "schedule_tickers", _csv("SCHEDULE_TICKERS"))
